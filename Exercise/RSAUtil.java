...
public class RSAUtil {
    ...
    public static void main(String[] args) {
        Map<String,String> m = generateKeyPair("/home/windard/Music");
        ...
        try{
            String mingwen = "This is mingwen for test to crypto RSA";
            String miwen = encrypt(getPublicKey(m.get("publicKey")),mingwen);
            System.out.println(mingwen);
            System.out.println("密文"+miwen);
            String result = decrypt(getPrivateKey(m.get("privateKey")),miwen);
